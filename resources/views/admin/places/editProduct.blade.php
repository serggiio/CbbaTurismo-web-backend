...
<html lang="en">
  ...
  <div class="main-content">
    ...
    <div class="card shadow-lg p-3 mb-5 rounded">
        ...
        <hr>
        <a class="btn btn-success col-md-1" href="{{ route('front.placeDetail', $product['touristicPlaceId'])}}" role="button"><i class="fas fa-arrow-circle-left"></i></a>
        <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-1"></div>  
                <div class="col-md-8">
                    ...
                    <form method="POST" action="{{ action('FrontController@storeUpdatedProduct') }}" style="padding-top: 5%" enctype="multipart/form-data">
                        @csrf <!-- {{ csrf_field() }} -->
