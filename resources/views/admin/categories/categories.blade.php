...
@include('admin.partials.fixedMenu')
  ...
  <div class="main-content">
    ...
    <div class="card shadow-lg p-3 mb-5 bg-body rounded">
        ...
        <div class="card-title"><h2 style="color: green"><i class="fas fa-bookmark navIcon" style="font-size: 120%; color: green"></i>  Categorías</h2></div>
        <hr>
        <div class="card-body">
                    ...
                    <tbody>                      
                        ...
                        @foreach($categories as $index => $category)
                          <tr>
                            ...
                            <td>
                                <a class="nav-link" href="{{ route('front.categoryDetail', $category['categoryId'])}}" style="width: fit-content">   
