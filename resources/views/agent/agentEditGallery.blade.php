...
@include('agent.partials.menu')
  ...
  <div class="main-content">
    ...
    <div class="card shadow-lg p-3 mb-5 rounded" style="background-image: linear-gradient(to top, #d9f2bc, #bfe396, #a5d470, #8ac449, #6eb512);">
        ...
        <hr>
        <a class="btn btn-success col-md-1" href="{{ route('frontAgent.placeDetail', $gallery['touristicPlaceId'])}}" role="button"><i class="fas fa-arrow-circle-left"></i></a>
        <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-1"></div>  
                <div class="col-md-6">
                    ...
                    <form method="POST" action="{{ action('AgentController@createImage') }}" style="padding-top: 5%" enctype="multipart/form-data">
                        @csrf <!-- {{ csrf_field() }} -->
                          ...
                          @foreach ($gallery['images'] as $item)
                            <div class="col-md-3 card" style="background-image: linear-gradient(to top, #d9f2bc, #c0e597, #a7d771, #8dca49, #71bc10);">
                              ...
                              <div class="card-footer">
                                <a href="{{route('frontAgent.galleryImageDestroy', $item['imageId'])}}" onclick="deleteControl({{ $gallery['images'] }})" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                              </div>
                            </div>
                          @endforeach
                        </div>
