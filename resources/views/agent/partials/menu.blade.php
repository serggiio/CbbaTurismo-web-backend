<nav class="navbar-primary">
    ...
    <ul class="navbar-primary-menu">
      <li>
        ...
        <a href="{{route('frontAgent.profile' , $user['userId'])}}"><i class="fas fa-user-circle navIcon"></i><span class="nav-label btn navButton">{{ $user['name']}}</span></a>
        <a href="{{ route('frontAgent.request')}}"><i class="fas fa-clipboard-list navIcon"></i><span class="nav-label btn navButton">Solicitudes</span></a>
